...
impl EmitOptions {
  fn new(layout_name: &'static str, mod_name: &'static str, min_struct_alignment: usize) -> Self {
    ...
    let mod_path = parse_quote!(moonwave_shader::#mod_name);
  ...
  fn emit(&self, input: DeriveInput) -> TokenStream {
            ...
            .map(|(index, field)| {
                ...
                quote! {
                    pub const fn #align_name() -> usize {
                        ...
                        moonwave_shader::internal::align_offset(
                            offset,
    ...
    quote! {
        ...
        unsafe impl #impl_generics moonwave_common::bytemuck::Zeroable for #generated_name #ty_generics #where_clause {}
        unsafe impl #impl_generics moonwave_common::bytemuck::Pod for #generated_name #ty_generics #where_clause {}
        ...
        impl #impl_generics #as_trait_path for #name #ty_generics #where_clause {
            ...
            fn #as_trait_method(&self) -> Self::#as_trait_assoc {
                Self::#as_trait_assoc {
                    ...
                    ..moonwave_common::bytemuck::Zeroable::zeroed()
                }
            }
        }
    }
